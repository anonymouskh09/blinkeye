    ...
    return (
      <div className="flex items-center gap-3 px-4 py-3.5 bg-slate-50 border-b border-gray-100 animate-fade-in">
        ...
        <input
          ...
          className="flex-1 text-sm bg-transparent border-b-2 border-primary outline-none py-0.5 text-gray-800"
        />
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
      <div className="lg:col-span-2 space-y-4">
          ...
          {descEditing ? (
            <div className="px-4 py-3 animate-fade-in">
              ...
              <textarea value={descDraft} onChange={(e) => setDescDraft(e.target.value)} rows={4}
                className="w-full text-sm border border-gray-200 rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-primary-500/30" />
              <div className="flex gap-2 mt-2">
                <button type="button" onClick={() => setDescEditing(false)} className="px-3 py-1.5 text-sm text-gray-600 hover:bg-gray-100 rounded">Cancel</button>
                <button type="button" onClick={saveDescription} className="px-3 py-1.5 text-sm bg-primary text-white rounded hover:bg-primary-700">Save</button>
              </div>
            </div>
          ) : (
            <div className="flex items-center px-4 py-3.5 border-b border-gray-100 hover:bg-slate-50/50">
              <dt className="w-44 shrink-0 text-sm text-gray-600">Client Description</dt>
        ...
        <p className="text-sm text-primary hover:underline cursor-pointer inline-flex items-center gap-1 pl-1">
