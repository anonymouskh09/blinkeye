...
export default function KanbanBoard({ data, onUpdate, variant = "default" }: KanbanBoardProps) {
  ...
  return (
    ...
    <div>
      ...
      <DndContext sensors={sensors} collisionDetection={closestCorners}
        ...
        <div className="flex gap-0 overflow-x-auto pb-4">
          ...
          {visibleStages.map((stage, idx) => (
            ...
            <div key={stage} className="flex items-stretch">
              ...
              <KanbanColumn stage={stage} cards={stages[stage] || []} variant={variant} />
        ...
        <DragOverlay>{activeCard && <CandidateCard card={activeCard} variant={variant} />}</DragOverlay>
