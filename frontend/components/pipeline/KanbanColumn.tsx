...
export default function KanbanColumn({ stage, cards, variant = "default" }: KanbanColumnProps) {
      ...
      >
        ...
        <div className="p-2 space-y-2 min-h-[200px] max-h-[calc(100vh-320px)] overflow-y-auto">
          ...
          {cards.map((card) => (
            ...
            <CandidateCard key={card.assignment_id} card={card} variant="manatal" />
    ...
    >
      ...
      <div className="space-y-2 min-h-[100px]">
        ...
        {cards.map((card) => (
          ...
          <CandidateCard key={card.assignment_id} card={card} />
